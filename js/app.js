//  var makerjs = require('makerjs'); // Library by Microsott for laser cuter create dxf files(Inutile pour le moment)
...
$("#validate_square").click(function(){ // Lorsque l'on clique sur le bouton avec l'id  #valide dans le html
  ...
  // Et à ce moment est la le canvas créer et ajoute le rect(rectangle ou carré en fonction de l - h que a entrer le client dans les parametre)
